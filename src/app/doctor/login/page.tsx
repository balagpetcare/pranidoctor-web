...
export default function DoctorLoginPage() {
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-linear-to-b from-teal-50/90 via-zinc-50 to-zinc-100 dark:from-teal-950/40 dark:via-zinc-950 dark:to-zinc-950"
        aria-hidden
      />
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 py-10 sm:py-16">
        <header className="mb-6 flex max-w-sm flex-col items-center text-center sm:mb-8">
          <div
            className="mb-4 hidden h-14 w-14 items-center justify-center rounded-2xl bg-teal-100 text-teal-800 shadow-sm ring-1 ring-teal-900/10 dark:bg-teal-950/60 dark:text-teal-200 dark:ring-teal-500/20 sm:flex"
            aria-hidden
          >
            <PawPrint className="h-7 w-7" strokeWidth={1.75} />
          </div>
          <p className="text-xs font-medium uppercase tracking-wider text-teal-800/80 dark:text-teal-400/90">
            Doctor
          </p>
          ...
          <p className="mt-2 max-w-xs text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            ডাক্তার প্যানেল — নির্ধারিত সেবা অনুরোধ পরিচালনা
          </p>
        </header>
