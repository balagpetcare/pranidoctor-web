...
**Related docs:** [MONITORING_COMPLETE.md](../../MONITORING_COMPLETE.md), [monitoring-guide.md](../../../pranidoctor_user/docs/monitoring-guide.md), [ARCHITECTURE_DECISION_RECORD.md](../../../pranidoctor-backend/docs/ops/ARCHITECTURE_DECISION_RECORD.md)

> **Canonical copy:** This document is mirrored in all three repos at `docs/production/monitoring/sentry-integration-plan.md`. Update all copies together.
...
- [ ] 7-day burn-in per launch readiness docs
...
3. Confirm issue appears within 5 minutes.
